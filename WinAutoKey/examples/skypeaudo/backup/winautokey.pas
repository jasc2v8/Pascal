...
0.119 Add SetBlockInput, requires run as Admin
0.118 Delete _SendMouseInput(x,y) with MulDiv, and MathRound
0.117 Change GetKeyState to GetVKeyState to avoid conflict with LCLType.GetKeyState
...
const
  ...
  //
    ...
    VK_TAB        = 9;
    VK_CLEAR      = 12;
    VK_RETURN     = 13; //$0D // The "Enter" key, also used for a keypad center press
    //14, 15 SI/SO
    VK_SHIFT      = 16; //$10 // See also VK_LSHIFT, VK_RSHIFT
    VK_CONTROL    = 17; //$11// See also VK_LCONTROL, VK_RCONTROL
    VK_MENU       = 18; //$12 // The ALT key, or "Option" in Mac OS X. See VK_LMENU, VK_RMENU
    ...
    VK_KANJI      = 25;
    //26 SUB
    VK_ESCAPE     = 27; //$1B // Also used for the hardware Back key in Android
    VK_CONVERT    = 28;
    VK_NONCONVERT = 29;
    VK_ACCEPT     = 30;
    VK_MODECHANGE = 31;
