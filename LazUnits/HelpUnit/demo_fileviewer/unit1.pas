...
uses
  ...
  StdCtrls, EditBtn, htmlfileviewer;
...
begin
  HelpForm.OpenFile(GetCurrentDir+'\res\help.html');
end;

procedure TfrmMain.btnOpenClick(Sender: TObject);
begin
  if OpenDialog1.Execute then
    HelpForm.OpenFile(OpenDialog1.FileName);
end;

procedure TfrmMain.btnFileClick(Sender: TObject);
begin
  HelpForm.OpenFile(GetCurrentDir+'\res\index.html');
end;
procedure TfrmMain.btnResourceClick(Sender: TObject);
begin
  HelpForm.OpenResource('index.html');
end;
procedure TfrmMain.btnURLClick(Sender: TObject);
begin
  HelpForm.OpenURL('https://www.freepascal.org/');
end;
